...
export default function Footer() {
  return (
    <footer className="card heading">
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div>
            <Link href="/" className="w-15 xl:w-40 mb-9">
              <svg
                width="256"
                height="98"
                viewBox="0 0 256 98"
            ...
            <p className="footer leading-relaxed mb-6">
          ...
          <div className="mt-8">
            <h4 className="text-sm tracking-wider heading mb-6">QUICK LINKS</h4>

            <ul className="space-y-4">
              <li>
                <Link href="/menus" className="nav-link transition-colors">
                  Menu
                </Link>
              </li>
              <li>
                <Link href="/about_us" className="nav-link transition-colors">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/contact_us" className="nav-link transition-colors">
                  Contact Us
                </Link>
              </li>
              <li>
                <Link href="/career" className="nav-link transition-colors">
                  Career
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-16 py-8 border-t border_border flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm sub_heading">
            © 2026 BamBite Restaurant. All rights reserved.
          </p>
          <div className="flex gap-6">
            <Link href="#" className="text-sm sub_heading transition-colors">
              Privacy Policy
            </Link>
            <Link href="#" className="text-sm sub_heading transition-colors">
              Terms of Service
