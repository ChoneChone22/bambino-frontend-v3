      ...
      <div className="relative z-10 w-full px-6 md:px-12 lg:px-20">
        <div className="max-w-2xl">
          ...
          <p className="mt-8 text-background/80 max-w-xl leading-relaxed">
            Simple ingredients, transformed with skill into extraordinary flavors.
          </p>
          <a 
            href="#reserve"
            className="inline-block mt-10 px-8 py-3 border border-primary hover:text-white text-background text-sm tracking-wider uppercase hover:bg-primary hover:text-foreground transition-all duration-300"
          >
            Order Now
          </a>
        </div>
